...
const Banner = ({ storedUser, setStoredUser }) => {
    ...
    return (
        // <div id='banner' className={`banner ${showBanner ? 'banner-visible' : 'banner-hidden'}`}>
        <div id='banner' className='banner'>
            <div className="banner-content">
                <div class="navbarlogo">                
                    <a onClick={() => navigate('/')}  ><img loading="lazy" src={logo} alt="Medihant" /></a>
                </div>
                {/* Sidebar */}
                ...
                <div className="banner-right">
                    {isLoggedIn ? (
                        <div className="auth-buttons">
                            {/* <span className="welcome-text">&nbsp;{storedUser.fullName}</span> */}
